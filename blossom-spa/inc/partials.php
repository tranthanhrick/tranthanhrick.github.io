...
function blossom_spa_get_team_content(){
    return wpautop( wp_kses_post( get_theme_mod( 'team_content', __( 'Some of our team members have 10+ years of experience. You can introduce your team members to give a more human feeling to the company.', 'blossom-spa' ) ) ) );
}
endif;
